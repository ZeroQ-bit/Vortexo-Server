...
interface SettingsData {
  ...
  plex_export_mode: string;
  plex_export_rd_mount_path: string;
  plex_export_movies_path: string;
  plex_export_shows_path: string;
  plex_refresh_enabled: boolean;
  plex_url: string;
  plex_token: string;
  plex_movies_section_id: string;
  plex_shows_section_id: string;
          ...
          <div className="bg-[#1e1e1e] rounded-xl p-6 border border-white/10">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-4 rounded-xl border border-white/10 bg-[#1f1f1f]/70 p-4 space-y-4">
                  <label className="flex items-start justify-between gap-4 cursor-pointer">
                    <div>
                      <div className="text-sm font-medium text-white">
                        Export cached items into Plex libraries
                      </div>
                      <div className="text-xs text-slate-400 mt-1">
                        Creates Plex-visible symlinks from your mounted
                        Real-Debrid library so cached items can land in Plex
                        automatically.
                      </div>
                    </div>
                    <input
                      type="checkbox"
                      checked={settings?.plex_export_enabled || false}
                      onChange={(e) =>
                        updateSetting("plex_export_enabled", e.target.checked)
                      }
                      className="w-4 h-4 mt-1 bg-[#2a2a2a] border-white/10 rounded"
                    />
                  </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-2">
                        Real-Debrid Mount Path
                      </label>
                      <input
                        type="text"
                        value={settings?.plex_export_rd_mount_path || ""}
                        onChange={(e) =>
                          updateSetting(
                            "plex_export_rd_mount_path",
                            e.target.value,
                          )
                        }
                        className="w-full px-3 py-2 bg-[#2a2a2a] border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500"
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        min={1}
                        value={settings?.plex_export_interval_minutes || 15}
                        onChange={(e) =>
                          updateSetting(
                            "plex_export_interval_minutes",
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={settings?.plex_export_movies_path || ""}
                        onChange={(e) =>
                          updateSetting("plex_export_movies_path", e.target.value)
                        }
                        className="w-full px-3 py-2 bg-[#2a2a2a] border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500"
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={settings?.plex_export_shows_path || ""}
                        onChange={(e) =>
                          updateSetting("plex_export_shows_path", e.target.value)
                        }
                        className="w-full px-3 py-2 bg-[#2a2a2a] border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500"
                        placeholder="/mnt/plex/shows"
                      />
                    </div>
                  </div>

                  <div className="rounded-lg border border-white/10 bg-[#202020] p-4 space-y-4">
                    <label className="flex items-start justify-between gap-4 cursor-pointer">
                      <div>
                        <div className="text-sm font-medium text-white">
                          Refresh Plex after export
                        </div>
                        <div className="text-xs text-slate-400 mt-1">
                          Optional. Triggers a Plex library refresh after new
                          symlinks are created.
                        </div>
                      </div>
                      <input
                        type="checkbox"
                        checked={settings?.plex_refresh_enabled || false}
                        onChange={(e) =>
                          updateSetting("plex_refresh_enabled", e.target.checked)
                        }
                        className="w-4 h-4 mt-1 bg-[#2a2a2a] border-white/10 rounded"
                      />
                    </label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={settings?.plex_movies_section_id || ""}
                          onChange={(e) =>
                            updateSetting(
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={settings?.plex_shows_section_id || ""}
                          onChange={(e) =>
                            updateSetting(
                              "plex_shows_section_id",
                              e.target.value,
                            )
                          }
                          className="w-full px-3 py-2 bg-[#2a2a2a] border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500"
